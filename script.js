var Particles = function (e, t) {
    ...
    return (n = function () {
        ...
        for (var e = this, t = e.options.minDistance, n = Math.sqrt, i = Math.abs, o = e.storage, r = o.length, a = 0; a < r; a++)
            for (var s = o[a], l = a + 1; l < r; l++) {
                var c = o[l],
                    f = s.x - c.x,
                    p = s.y - c.y;
                if (d = n(f * f + p * p), i(f) > t) break;
                d <= t && e._drawEdge(s, c, 1.2 - d / t);
            }
        var d;
    }, n.prototype._drawEdge = function (e, t, n) {
        var i = this,
            o = i.context.createLinearGradient(e.x, e.y, t.x, t.y),
            r = i._hex2rgb(e.color),
            a = i._hex2rgb(t.color);
        ...
        var o = this,
            r = Math.random,
            a = i.speed,
            s = i.color instanceof Array ? i.color[Math.floor(r() * i.color.length)] : i.color;
    ...
    }, e.requestAnimFrame = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || function (t) {
